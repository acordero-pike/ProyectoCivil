...
namespace Bomberos.Controllers
{
    ...
    public class TurnoesController : Controller
    {
        ...
        public TurnoesController(BomberoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTurno,Nombre,Descripcion,Horario")] Turno turno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("IdTurno,Nombre,Descripcion,Horario")] Turno turno)
        {
            if (id != turno.IdTurno)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'BomberoContext.Turnos'  is null.");
            }
            var turno = await _context.Turnos.FindAsync(id);
            if (turno != null)
            {
